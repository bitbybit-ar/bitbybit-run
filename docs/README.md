...
| [PWA.md](PWA.md)                   | Install as an app: manifest, generated icons, the mobile-only install prompt, Android vs iOS, future offline support |
| [TESTING.md](TESTING.md)           | Automated tests: layout, how to run unit/integration, CI jobs, and what they cover                                   |

> Looking for the project overview, tech stack, or hackathon scoring map? See the
> root [`../README.md`](../README.md). Release notes (per version) live in the
> root [`../CHANGELOG.md`](../CHANGELOG.md).

## Conventions

- Documentation is written in **English**.
- Every notable change is recorded in the root [CHANGELOG.md](../CHANGELOG.md).
